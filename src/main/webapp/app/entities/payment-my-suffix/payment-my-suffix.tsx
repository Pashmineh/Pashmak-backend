...
import { getEntities, reset } from './payment-my-suffix.reducer';
import { IPaymentMySuffix } from 'app/shared/model/payment-my-suffix.model';
// tslint:disable-next-line:no-unused-variable
import { APP_DATE_FORMAT, APP_LOCAL_DATE_FORMAT } from 'app/config/constants';
import { ITEMS_PER_PAGE } from 'app/shared/util/pagination.constants';

export interface IPaymentMySuffixProps extends StateProps, DispatchProps, RouteComponentProps<{ url: string }> {}

export type IPaymentMySuffixState = IPaginationBaseState;

export class PaymentMySuffix extends React.Component<IPaymentMySuffixProps, IPaymentMySuffixState> {
  state: IPaymentMySuffixState = {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="payment-my-suffix-heading">
          Payments
              ...
              <tbody>
                {paymentList.map((payment, i) => (
                  <tr key={`entity-${i}`}>
                    ...
                    <td>
                      <TextFormat type="date" value={payment.paymentTime} format={APP_DATE_FORMAT} />
                    </td>
